...
public class ResValuePrivate {
	...
	public ResValuePrivate() {
	}
	public ResValuePrivate(ResValue val) {
		id =  val.getId();
		ELEMENT_VALUE = val.getELEMENT_VALUE();
		CLUE_SRC_SYS = val.getCLUE_SRC_SYS();
		VALUE_NAME = val.getVALUE_NAME();
		VALUE_SENSITIVE_ID = val.getVALUE_SENSITIVE_ID();
		ELEMENT = val.getELEMENT();
		DELETE_STATUS = val.getDELETE_STATUS();
		DATA_VERSION = val.getDATA_VERSION();
		LATEST_MOD_TIME = val.getLATEST_MOD_TIME();
	}
	public int getId() {
		return id;
	}
