...
public class ResRelationRowPrivate {
	...
	public ResRelationRowPrivate(ResRelationRow rr) {
		...
		CLUE_SRC_SYS = rr.getCLUE_SRC_SYS();
		ELEMENT_VALUE = rr.getELEMENT_VALUE();
		DELETE_STATUS = rr.getDELETE_STATUS();
		DATA_VERSION = rr.getDATA_VERSION();
		LATEST_MOD_TIME = rr.getLATEST_MOD_TIME();
	}
	public int getId() {
		return id;
	}
