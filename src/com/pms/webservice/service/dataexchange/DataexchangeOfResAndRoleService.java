...
public class DataexchangeOfResAndRoleService extends DataexchangeService {

	private Log logger = LogFactory.getLog(DataexchangeOfResAndRoleService.class);
	
	protected DataexchangeOfResAndRoleService(ExchangeCondition ec) {
		super(ec);
	}
	
	public void ExecuteUpdate() throws Exception {
		if( ec == null || ec.getCommon010131() == null || ec.getCommon010131().getItems() == null || ec.getCommon010131().getItems().size() == 0 ) {
			String message = "[DESIRR]更新功能资源与角色关系数据操作的条件不完整.";
			logger.info(message);
