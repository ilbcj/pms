...
public interface AttributeDAO {
	...
	List<AttrDictionary> GetDictsDatasNode(String name, String code, String id) throws Exception;
	List<AttrDictionary> GetDictsDataTemplatesNode(String name, String code, String id) throws Exception;
